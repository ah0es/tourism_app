...
class Styles {
  ...
  static TextStyle styleTime = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 32 : 32.sp,
    fontWeight: FontWeight.w300,
  );
  static TextStyle style12700 = TextStyle(
    color: AppColors.textColor,
  ...
  static TextStyle style30700 = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 30 : 30.sp,
    fontWeight: FontWeight.w700,
  );
  static TextStyle style11500 = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 11 : 11.sp,
    fontWeight: FontWeight.w500,
  );
  static TextStyle style14400 = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 14 : 14.sp,
    fontWeight: FontWeight.w400,
  );
  static TextStyle style15400 = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 15 : 15.sp,
    fontWeight: FontWeight.w400,
  );
  ...
  static TextStyle style14500 = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 14 : 14.sp,
    fontWeight: FontWeight.w500,
  );
  static TextStyle style16300 = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 16 : 16.sp,
    fontWeight: FontWeight.w300,
  );
  static TextStyle style14600 = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 14 : 14.sp,
    fontWeight: FontWeight.w600,
  );
  static TextStyle style15500 = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 15 : 15.sp,
    fontWeight: FontWeight.w500,
  );
  static TextStyle style15600 = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 15 : 15.sp,
    fontWeight: FontWeight.w600,
  );
  static TextStyle style14700 = TextStyle(
    color: AppColors.textColor,
    fontSize: Constants.tablet ? 14 : 14.sp,
    fontWeight: FontWeight.w700,
  );
  static TextStyle style40700 = TextStyle(
    fontWeight: FontWeight.w700,
    fontSize: Constants.tablet ? 40 : 40.sp,
    color: AppColors.textColor,
  );

  static TextStyle style20700 = TextStyle(
    fontSize: Constants.tablet ? 20 : 20.sp,
    fontWeight: FontWeight.w700,
    color: AppColors.textColor,
  );
  static TextStyle style20300 = TextStyle(
    fontSize: Constants.tablet ? 20 : 20.sp,
    fontWeight: FontWeight.w300,
    color: AppColors.textColor,
  );
  ...
  static TextStyle style18500 = TextStyle(
  ...
  static TextStyle style16500 = TextStyle(
    fontSize: Constants.tablet ? 16 : 16.sp,
    fontWeight: FontWeight.w500,
    color: AppColors.textColor,
  );
  static TextStyle style17500 = TextStyle(
    fontSize: Constants.tablet ? 17 : 17.sp,
    fontWeight: FontWeight.w500,
    color: AppColors.textColor,
  );
